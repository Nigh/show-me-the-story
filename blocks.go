...
func ReviseBlockAction(ctx context.Context, apiCfg *APIConfig, cfg *Config, state *Progress, progressPath string, chapterNum, blockID int, feedback string, settings *ProjectSettings, logger *LogBroadcaster) error {
